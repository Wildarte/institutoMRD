    ...
    <main>
            ...
            <div class="hist_content container d-flex">
                <div class="hist_left f-50 animate__animated animate__lightSpeedInLeft">
                    ...
                    <div class="bottom_hist">
                        <a class="link_hist" href="#">Saiba mais ></a>
                    </div>
                </div>

                <div class="hist_right f-50">
                    <img class="hist_main_img" src="assets/img/casa2.png" alt="">
                    <img class="hist_float_img" src="assets/img/dot.png" alt="">
                </div>
            </div>
        </section>
        ...
        <section class="wedo container_full d-flex">
            ...
            <div class="wedo_left f-50">
                <img src="assets/img/we_do.jpg" alt="">
            </div>
            ...
            <div class="wedo_right f-50 animate__animated animate__lightSpeedInRight">
                ...
                <section class="cards_wedo d-flex">
                    ...
                    <article class="card_wedo f-50 b-bot-yellow">
                        <img src="assets/img/arrow-yellow.png" alt="">
                        <p>Comprometimento</p>
                    </article>
        ...
        <section class="impacto container_full">
            <div class="impacto_content container">
                ...
                <ul class="numbers_impacto">
                    <li>
                        <h3 class="isOnScreen" id="count1">4.013</h3>
                        <p>crianças impactadas</p>
                    </li>
                    <li>
                        <h3 class="isOnScreen" id="count2">67</h3>
                        <p>Projetos desenvolvidos</p>
                    </li>
                    <li>
                        <h3 class="isOnScreen" id="count3">13</h3>
                        <p>Comunidades impactadas</p>
                    </li>
                    <li>
                        <h3 class="isOnScreen" id="count4">22</h3>
                        <p>Voluntários
                            envolvidos</p>
                    </li>
                </ul>
        ...
        <section class="conteudo container_full">
                ...
                <article class="card_post">
                    <a href="#">
                        ...
                        <div class="post_info">
                            ...
                            <h3>Projeto transforma educando em educador</h3>
                            <p>No Instituto MRD, todo mundo ensina e aprende ao mesmo tempo. As crianças do projeto se encantaram com…</p>
                            
                            <p style="color: #333; margin-top: 10px;">Saiba mais</p>

                        </div>
                
                        <p class="post_bottom"> <time>10 julho</time> . <span>03</span> comentários</p>
                ...
                <article class="card_post">
                    <a href="#">
                        ...
                        <div class="post_info">
                            ...
                            <h3>Aprender errando: a resiliência emocional...</h3>
                            <p>A tolerância ao estresse e a autoconfiança são competências fundamentais para o desenvolvimento...</p>
                ...
                <article class="card_post">
                    <a href="#">
                        ...
                        <div class="post_info">
                            ...
                            <h3>Instituto MRD promove festa no Dia das Crian...</h3>
                            <p>Crianças e adolescentes de Manoel Brandão tiveram uma tarde de lanches, brincadeiras e atividades voltadas para o de...</p>
                        ...
                        <span class="post_cat bg-blue">Eventos</span>
                    </a>
                </article>
                ...
                <article class="card_post">
                    <a href="#">
                        ...
                        <div class="post_info">
                            ...
                            <h3>Projeto do Instituto ampliará a atuação...</h3>
                            <p>A nossa missão sempre foi promover o desenvolvimento humano de crianças e adolescentes. O esporte tem...</p>
                ...
                <article class="card_post">
                    <a href="#">
                        ...
                        <div class="post_info">
                            ...
                            <h3>Natal com diversão, doações e surpresas</h3>
                            <p>Mais de 50 crianças de Manoel Brandão e São José da Lapa receberam uma visita especial do Papai Noel...</p>
                ...
                <article class="card_post">
                    <a href="#">
                        ...
                        <div class="post_info">
                            ...
                            <h3>Reforma de casa faz a alegria de família...</h3>
                            <p>O instituto MRD reuniu voluntários para ajudar na reforma do telhado em uma casa no Morro das Pedras...</p>
                        ...
                        <span class="post_cat bg-blue">Notícias</span>
                    </a>
                </article>
            ...
            <div class="btn_more_post">
                <a class=" btn-gray" href="#">Ver mais</a>
            </div>
        ...
        <section class="pilares container_full">
            <div class="pilares_content container">
                ...
                <h2 class="title_pilares title-default">Buscando transformar a vidas</h2>
                ...
                <section class="cards_pliares d-flex">
                    ...
                    <article class="card_pilares b-bot-orange">
                        <img src="assets/img/arrow-orange.png" alt="">
                        <div class="card_pilares_info">
                            <h3>Esporte</h3>
        ...
        <section class="projetos container_full">
            ...
            <div class="ofer_content container d-flex">
                ...
                <div class="ofer_right f-50 d-flex">
                    <article class="icons_ofer">
                        <img src="assets/img/card_ofer1.jpg" alt="">
                        <h3 class="desc-default">INFORMÁTICA</h3>
                    </article>
                    <article class="icons_ofer">
                        <img src="assets/img/card_ofer2.jpg" alt="">
                        <h3 class="desc-default">ATENDIMENTO ODONTOLÓGICO</h3>
                    </article>
                    <article class="icons_ofer">
                        <img src="assets/img/card_ofer3.jpg" alt="">
                        <h3 class="desc-default">ATENDIMENTO JURÍDICO</h3>
                    </article>
                    <article class="icons_ofer">
                        <img src="assets/img/card_ofer4.jpg" alt="">
        ...
        <section class="contact_form container d-flex">
            ...
            <form action="" class="form">
                ...
                <button class="btn-gray" type="submit">Enviar</button>
            </form>
        </section>
        ...
        <section class="our container_full">
            ...
            <div class="our_gallery container d-flex">
                ...
                <div class="our_gallery_left f-50">
                 ...
                 -->
                 <div class="our_gallery_right f-50 d-flex">
                    <div class="card_gallery">
                        <img src="assets/img/gal1.png" alt="">
                    </div>
                    <div class="card_gallery">
                        <img src="assets/img/gal2.png" alt="">
                    </div>
                    <div class="card_gallery">
                        <img src="assets/img/gal3.png" alt="">
                    </div>
                    <div class="card_gallery">
                        <img src="assets/img/gal4.png" alt="">
                    </div>
                </div>
                <div class="our_gallery_right f-50 d-flex">
                    <div class="card_gallery">
        ...
        <section class="testi container_full">
            <header class="header_testi container">
                <h3 class="subtitle-default">Testemunhos</h3>
            ...
            <div class="testi container_full">
                <div class="row_testi_top d-flex">
                    ...
                    <article class="item_testi d-flex">
                        ...
                        <div class="testi_show">
                                <p class="desc-default" style="font-size: .9em;">“Tive a oportunidade de ver de perto alguns do projeto do instituto. A equipe inteira está de parabéns!!”</p>
                                <p>
                                    ⭐⭐⭐⭐⭐
                                </p>
                ...
                <div class="row_testi_bottom d-flex">
                    <article class="item_testi">
                        <div class="card_testi">
                            <img src="assets/img/testi7.png" alt="">
                            <div class="testi_desc">
                                <i class="bi bi-quote"></i>
                                <p>“Não há nada melhor do que ver o sorriso no rosto das crianças. Essas ações realmente transformam vidas. Estão de parabéns!”</p>
                                <strong>Carlos Eduardo</strong>
